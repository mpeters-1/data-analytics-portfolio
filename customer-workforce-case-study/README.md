...
- Job roles such as **Craft-repair and Executive Management** show higher representation among higher earners in the filtered segment.
- Workforce distribution is not uniform across income levels, even within the same education category.
- Certain roles show stronger association with higher income outcomes, suggesting occupational stratification within similar education levels.
...
- Feature engineering and column renaming
- Boolean filtering and segmentation
- Group-based aggregation and normalization
- Data visualization (Matplotlib)
- Workforce and income analytics interpretation

---

## Potential Applications

This analysis could be extended for:

- HR workforce planning dashboards
- Salary benchmarking models
- Diversity and equity workforce studies
- Career pathway analysis
- Public policy and labor economics research

---

## Future Improvements

- Add Seaborn visualizations for improved aesthetics
- Build interactive dashboard (Plotly / Tableau)
- Expand analysis to include education-income regression modeling
- Normalize across all education levels, not just HS graduates

---

## Author

Data Analytics Portfolio Project — Workforce Intelligence Case Study
